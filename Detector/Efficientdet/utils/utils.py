...
def xywh_to_xyxy(boxes_xywh):
    boxes_xyxy = boxes_xywh.clone() if isinstance(boxes_xywh, torch.Tensor) else boxes_xywh.copy()
...
def xyxy_to_xywh(boxes_xyxy: np.array):
    boxes_xywh = boxes_xyxy.clone() if isinstance(boxes_xyxy, torch.Tensor) else boxes_xyxy.copy()
